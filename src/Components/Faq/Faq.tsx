      ...
      <div className="Acordeon">
        <Accordion defaultActiveKey="0">
          <Accordion.Item eventKey="0">
            <Accordion.Header>
              <h3 className="question">Qué beneficios tiene tener una página web?</h3>
            </Accordion.Header>
            <Accordion.Body>
              <h3>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header>
              <h3 className="question">Cuál es la duración del hosting y qué incluye?</h3>
            </Accordion.Header>
            <Accordion.Body>
              <h3>
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header>
              <h3 className="question">Por qué debería elegir vuestros servicios en lugar de otros?</h3>
              
            </Accordion.Header>
            <Accordion.Body>
              <h3>Nuestros servicios se destacan porque no utilizamos plantillas
          ...
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
              <h3 className="question">Aceptamos transferencia bancaria y pagos en efectivo. Estamos
              comprometidos a brindarte opciones de pago seguras y convenientes.</h3>
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body>
              <h3>Sí, proporcionamos facturas para empresas. Nos aseguramos de
              cumplir con todos los requisitos de facturación y proporcionarte
              los detalles necesarios para tus registros.</h3>
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="5">
            ...
            <Accordion.Body>
              <h3>Puedes ponerte en contacto con nosotros a través de nuestro
              ...
              ayudarte en el proceso de obtener tu página web.</h3>
            </Accordion.Body>
          </Accordion.Item>
        </Accordion>
      </div>
